...
const S = {
  ...
  scroll: { overflowX:'auto' as const, WebkitOverflowScrolling:'touch' as any } as React.CSSProperties,
  ...
  tHead:  { display:'grid', padding:'10px 16px', borderBottom:'1px solid rgba(255,255,255,0.06)', fontSize:11, fontWeight:700, color:'#4b5563', textTransform:'uppercase' as const, letterSpacing:'0.08em', minWidth:640 } as React.CSSProperties,
  tRow:   { padding:'13px 16px', borderBottom:'1px solid rgba(255,255,255,0.04)', fontSize:13, alignItems:'center', transition:'background 0.15s', minWidth:640 } as React.CSSProperties,
  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.body}>
        ...
        {/* ── MERCHANTS ── */}
        {tab==='Merchants' && (
          <div style={{...S.card, overflowX:"auto"}}><div style={{...S.tHead,gridTemplateColumns:'1.5fr 1.5fr 1fr 1fr 1fr'}}>
        ...
        {/* ── KYC ── */}
        {tab==='KYC' && (
          <div style={{...S.card, overflowX:"auto"}}><div style={{...S.tHead,gridTemplateColumns:'1.5fr 1fr 1fr 1fr 1fr 0.8fr'}}>
        ...
        {/* ── FRAUD ALERTS ── */}
        {tab==='Fraud Alerts' && (
          <div style={{...S.card, overflowX:"auto"}}><div style={{...S.tHead,gridTemplateColumns:'1.5fr 1fr 1fr 1fr 1fr'}}>
        ...
        {/* ── SUBSCRIPTIONS ── */}
        {tab==='Subscriptions' && (
          <div style={{...S.card, overflowX:"auto"}}><div style={{...S.tHead,gridTemplateColumns:'1.5fr 1.5fr 1fr 1fr'}}>
