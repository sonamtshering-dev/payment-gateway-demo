      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 64 }}>
        <div style={{ width: '100%', maxWidth: 480, padding: '0 20px' }}>
          <div style={{ textAlign: 'center' as const, marginBottom: 36 }}>
            <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: 42, fontWeight: 800, color: '#93c5fd', marginBottom: 10, letterSpacing: -1 }}>Welcome back</h1>
            <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.4)' }}>Don't have an account? <Link href="/auth/register" style={{ color: '#60a5fa', fontWeight: 600, textDecoration: 'none' }}>Sign up</Link></p>
          </div>
          ...
          <div style={{ background: '#0f1d35', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '36px 32px' }}>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: 'block', fontSize: 14, color: 'rgba(255,255,255,0.65)', fontWeight: 500, marginBottom: 8 }}>Email address <span style={{ color: '#ef4444' }}>*</span></label>
                <input style={inp} type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} required />
              </div>
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: 'block', fontSize: 14, color: 'rgba(255,255,255,0.65)', fontWeight: 500, marginBottom: 8 }}>Password <span style={{ color: '#ef4444' }}>*</span></label>
                <div style={{ position: 'relative' as const }}>
                  <input style={{ ...inp, paddingRight: 48 }} type={showPw ? 'text' : 'password'} placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} required />
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: 'rgba(255,255,255,0.45)', cursor: 'pointer' }}>
                  <input type="checkbox" />Remember me
                </label>
                <span style={{ fontSize: 14, color: '#60a5fa', cursor: 'pointer' }}>Forgot password?</span>
              </div>
