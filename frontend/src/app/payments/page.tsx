...
const S: Record<string, any> = {
  ...
  btn: { background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)', border: 'none', borderRadius: 10, padding: '13px 24px', color: '#0a0f1a', fontWeight: 700, fontSize: 14, cursor: 'pointer', width: '100%', marginTop: 8 },
  ...
  linkBox: { background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: 10, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 },
  linkText: { flex: 1, color: '#3b82f6', fontSize: 13, wordBreak: 'break-all' as const, fontFamily: 'monospace' },
  copyBtn: { background: 'rgba(59,130,246,0.15)', border: '1px solid rgba(59,130,246,0.3)', borderRadius: 8, padding: '7px 14px', color: '#3b82f6', fontSize: 12, cursor: 'pointer', whiteSpace: 'nowrap' as const },
  ...
  tag: (s: string) => ({ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 10px', borderRadius: 20, fontSize: 12, fontWeight: 600, background: s === 'paid' ? 'rgba(59,130,246,0.1)' : s === 'failed' ? 'rgba(239,68,68,0.1)' : 'rgba(245,158,11,0.1)', color: s === 'paid' ? '#3b82f6' : s === 'failed' ? '#ef4444' : '#f59e0b' }),
